...
\begin{frame}{Motivation}
  \begin{itemize}
    \item Focus: \textbf{$\alpha$-labeling} and a special family of trees -- banana trees
    \item Rosa (1967) introduced graceful ($\beta$) labeling and $\alpha$-labeling
    \item Ringel-Kotzig conjecture: All trees are graceful
...
\begin{frame}{RSF and isomorphic labelings}
  \begin{itemize}
    \item $\mathcal{L}_i = \{l_{i,j} \mid j \in [k-2] \}$ and $\mathcal{B}_i$ = $\{a_i\} \cup \mathcal{L}_i$
    \item swapping the labels of two leaves or two stars doesn't change the labeling
  \end{itemize}
  \begin{figure}[H]
    \centering
  ...
  \begin{figure}[H]
    ...
    \begin{minipage}{0.47\textwidth}
      ...
      \begin{tikzpicture}[scale=0.75, every node/.style={circle, draw, fill=black, inner sep=1pt}]
        ...
        \draw (central) -- (l21);
      \end{tikzpicture}
      \caption*{$\alpha$-labeling $f \in \mathcal{A}_1(2, k)$} \label{fig:B(2,k)a}
    \end{minipage}
    \hspace{2mm}
    \begin{minipage}{0.475\textwidth}
      ...
      \begin{tikzpicture}[scale=0.75, every node/.style={circle, draw, fill=black, inner sep=1pt}]
        ...
        \draw (central) -- (l21);
      \end{tikzpicture}
      \caption*{$\alpha$-labeling $f_y \in \mathcal{A}_2(2, k)$} \label{fig:B(2,k)b}
    \end{minipage}
    \caption{Two types of principal $\alpha$-labelings of $B(2, k)$ (with $k + 3 \le y \le 2k + 1$)} \label{fig:B(2, k)}
  \end{figure}
\end{frame}
